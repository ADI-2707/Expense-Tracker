      ...
      <form className='p-4 rounded shadow mx-auto' style={{maxWidth:'600px'}} onSubmit={handleSubmit}>
        <div className="mb-3">
            ...
            <div className="input-group">
                ...
                <input type="text" name="FullName" value={formData.FullName} className="form-control" onChange={handleChange} placeholder="Enter your full name" required/>
            </div>
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
            ...
            <div className="input-group">
                ...
                onChange={handleChange} placeholder="Create your password" required/>
            </div>
        </div>
